...
export class ProjectsService {
  ...
  projects: Project[] = [
    ...
    {id: 4, name: "Darts Calculator + Scorer", pictures: ["../../assets/dartcalculator1.png", "../../assets/dartcalculator2.png", "../../assets/dartcalculator3.png"], projectLink: "https://github.com/benmccarrick/darts-calculator", projectLink2: '',summary: "A calculator and scorer for the sport of darts. A front-end mobile app project using react-native and written in JavaScript.", description: "Darts is real hobby of mine, so I decided to build a calculator/scorer for when I play at home. There are apps like this already available, however none of them had the usability that I wanted. Users have the ability to score 1 or 2 player games, keep track of statistics such as Dart Averages, Highest Checkouts and 180s, or go back on any misclicks with the handy undo feature. This app takes all the mental arithmetic away from the user, as all calculations are done by the app when each dart is submitted, meaning the user can just concentrate on the darts!", tags: [Tag.JAVASCRIPT, Tag.REACTNATIVE]}
  ];
